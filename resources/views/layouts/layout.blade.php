...
<html lang="es" class="light-style layout-menu-fixed" dir="ltr">
  <head>
    ...
    <title>Fisio Derma</title>

    <meta name="description" content="" />
    <link rel="icon" type="image/x-icon" href="{{asset("imagenes/icono.png")}}" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-text demo menu-text fw-bolder ms-2">FISIODERMA</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{Route::current()->getName() == "pacientes"  ? "active" : "menu-item"}}">
              <a href="{{route('pacientes')}}" class="menu-link">
                <i class='menu-icon bx bx-folder-plus'></i>
            ...
            {{-- <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Administrador</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <li class="menu-item ">
                ...
                <a class="dropdown-item menu-link" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
